// This code was autogenerated with `dbus-codegen-rust -s -d org.freedesktop.NetworkManager -p /org/freedesktop/NetworkManager -i org.freedesktop.NetworkManager -m None`, see https://github.com/diwic/dbus-rs
use dbus;
